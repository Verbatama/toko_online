...
<div class="page-header">
    <h1><i class="zmdi zmdi-edit"></i> Edit Produk</h1>
    ...
    <form action="{{ route('admin.produk.update', $produk->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" name="nama_produk" class="form-control" value="{{ $produk->nama_produk }}" placeholder="Masukkan nama produk" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="image-preview">
                <img src="{{ $produk->gambar_produk }}" alt="{{ $produk->nama_produk }}" onerror="this.parentElement.style.display='none';">
            </div>
            @endif
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="number" name="harga_produk" class="form-control" value="{{ $produk->harga_produk }}" step="0.01" min="0" placeholder="0" required>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="number" name="stok_produk" class="form-control" value="{{ $produk->stok_produk }}" min="0" placeholder="0" required>
            </div>
        ...
        <div class="form-group">
            ...
            <textarea name="deskripsi_produk" class="form-control" rows="5" placeholder="Masukkan deskripsi produk..." required>{{ $produk->deskripsi_produk }}</textarea>
            <div class="form-help">Deskripsikan produk dengan detail</div>
        </div>

        <div class="form-actions">
            <button type="submit" class="btn btn-success">
                <i class="zmdi zmdi-check"></i> Update Produk
            </button>
